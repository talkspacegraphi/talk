...
export default function UserProfile({ userId, chatId, onClose, isSelf, onStartCall }: UserProfileProps) {
  ...
  return (
    <>
              ...
              <div className="bg-surface-secondary border border-border rounded-2xl shadow-2xl p-6 mx-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={blockLoading}
                    className="flex-1 px-4 py-2.5 rounded-xl bg-red-500 hover:bg-red-600 text-white transition-all text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                  >
      ...
      {/* Copy notification (Telegram-style) */}
      <AnimatePresence>
